...
export default function FormularioMultiStep({ onSubmitComplete }: FormularioMultiStepProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 md:px-0">
      ...
      <div className="bg-white/75 backdrop-blur-xl border-white/60 backdrop-blur-md border border-white/30 rounded-full px-6 py-4 shadow-elegant flex items-center justify-between overflow-x-auto gap-4">
        {STEPS.map((step, idx) => {
            ...
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center shrink-0">
                <button
                  ...
                  className={`w-9 h-9 rounded-full border-2 flex items-center justify-center font-sans font-medium text-xs transition-all duration-300
                    ...
                    ${isCurrent && !isCompleted ? "border-[#059669] bg-white text-[#059669] scale-105 shadow-md" : ""}
              ...
              {!isLast && (
                <div className="h-[2px] flex-1 bg-[#475569]/20 rounded min-w-[20px]">
                  <div
                    className="h-full bg-[#059669] transition-all duration-300 rounded"
      ...
      <div className="bg-white/80 backdrop-blur-xl border-white/70 backdrop-blur-lg border border-white/40 rounded-3xl p-6 md:p-10 shadow-elegant mt-8 min-h-[460px] relative transition-all duration-300">
            ...
            <div className="space-y-5 max-w-lg mx-auto">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`rounded-full bg-slate-50/70 backdrop-blur-md border-slate-200/50 border-[#475569]/20 focus:bg-white focus:border-[#059669] focus:ring-0 ${
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
                    ...
                    <Label
                      ...
                      className={`flex-1 cursor-pointer border rounded-2xl p-4 flex flex-col justify-between h-20 transition-all duration-300
                        ${watch("tipoOperacion") === "compra" 
                          ? "bg-white border-[#059669] shadow-elegant scale-[1.02]" 
                          : "bg-white/75 backdrop-blur-xl border-white/60 border-[#475569]/10 hover:bg-white/60"
                        }
                      `}
                    >
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className={`rounded-full bg-slate-50/70 backdrop-blur-md border-slate-200/50 border-[#475569]/20 focus:bg-white focus:ring-0 ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="rounded-full bg-slate-50/70 backdrop-blur-md border-slate-200/50 border-[#475569]/20">
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 h-10 rounded-full border border-[#475569]/20 bg-slate-50/70 backdrop-blur-md border-slate-200/50 px-4 py-2 text-sm font-sans focus:bg-white focus:border-[#059669]"
                  >
                  ...
                  <Button
                    ...
                    className="rounded-full bg-[#059669] hover:bg-[#047857]"
                  >
                    Agregar
                  </Button>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className="rounded-full bg-slate-50/70 backdrop-blur-md border-slate-200/50 border-[#475569]/20 focus:bg-white focus:border-[#059669]"
                  />
                  <Button
                    type="button"
              ...
              <div className="space-y-3 bg-[#F1F5F9]/60 border border-[#059669]/25 rounded-2xl p-5 md:p-6 shadow-card">
                ...
                <Textarea
                  ...
                  className={`bg-white/70 border-[#475569]/20 focus:bg-white focus:border-[#059669] focus:ring-0 rounded-2xl ${
        ...
        {currentStep === 4 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`rounded-full pl-7 bg-slate-50/70 backdrop-blur-md border-slate-200/50 border-[#475569]/20 focus:bg-white focus:border-[#059669] focus:ring-0 ${
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  {METODOS_PAGO.map((metodo) => (
                    <div
                      key={metodo.id}
                      className="flex items-start space-x-3 p-4 bg-slate-50/70 backdrop-blur-md border-slate-200/50 border border-[#475569]/10 rounded-2xl hover:bg-white transition-colors duration-300 cursor-pointer shadow-card"
                    ...
                    >
                      <Checkbox
                        ...
                        className="mt-0.5 border-[#059669]/40 data-[state=checked]:bg-[#059669] data-[state=checked]:border-[#059669]"
                      />
              ...
              <div className="bg-white/75 backdrop-blur-xl border-white/60 border border-[#475569]/10 rounded-2xl p-5 shadow-card space-y-4">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
                        ...
                        <Label
                          ...
                          className={`flex-1 cursor-pointer border rounded-2xl p-4 flex gap-4 items-center transition-all duration-300 shadow-card
                            ${watch("usoDestino") === opc.id
                              ? "bg-white border-[#059669] scale-[1.01]"
                              : "bg-white/75 backdrop-blur-xl border-white/60 border-[#475569]/10 hover:bg-white/60"
                            }
                          `}
                        >
                          <div className="bg-[#F1F5F9] p-2.5 rounded-xl border border-[#475569]/10 text-[#059669]">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-slate-50/70 backdrop-blur-md border-slate-200/50 border-[#475569]/20 focus:bg-white focus:border-[#059669] focus:ring-0 rounded-2xl"
                />
              </div>
            </div>
          </div>
        ...
        {currentStep === 6 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-6 border border-[#475569]/15 shadow-card hover:border-[#059669]/30 transition-all duration-300 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full h-10 rounded-full border border-[#475569]/20 bg-white px-4 text-sm font-sans focus:border-[#059669] focus:outline-none"
                        />
                      </div>
                        ...
                        {citaVirtualFecha ? (
                          isLoadingBusySlots ? (
                            <div className="h-10 flex items-center justify-center text-xs text-[#475569]/60">
                              <Loader2 className="w-4 h-4 mr-2 animate-spin text-[#059669]" />
                                    ...
                                    className={`h-9 rounded-full text-xs font-sans font-medium border transition-all duration-300
                                      ${isBusy 
                                        ...
                                        : isSelected
                                          ...
                                          : "bg-white border-[#475569]/20 text-[#475569] hover:border-[#059669] hover:bg-[#F1F5F9]"
                                      }
                                    `}
                                  >
                                    {hour}
                ...
                <div className="space-y-3">
                  {TIPOS_DOCUMENTOS.map((doc) => {
                    ...
                    return (
                      <div
                        key={doc.id}
                        className="bg-white rounded-2xl p-4 border border-[#475569]/15 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-card hover:border-[#059669]/30 transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                          {uploadingDocs[doc.id] ? (
                            <Loader2 className="w-5 h-5 text-[#059669] animate-spin shrink-0" />
                          ) : isUploaded ? (
                          ...
                          <div>
                            ...
                            {uploadingDocs[doc.id] ? (
                              <span className="text-[10px] text-[#059669] font-sans font-medium animate-pulse">Subiendo a base de datos...</span>
                            ) : isUploaded ? (
                        ...
                        <div className="shrink-0 flex items-center gap-3">
                          <Button
                            ...
                            className={`rounded-full font-sans text-xs border-[#475569]/20 hover:bg-[#F1F5F9] hover:text-[#059669] ${
              ...
              {/* Nota de Alerta */}
              <div className="bg-[#F1F5F9] border border-[#059669]/20 rounded-2xl p-5 flex gap-3 shadow-card">
                <AlertCircle className="w-5 h-5 text-[#059669] shrink-0 mt-0.5" />
      ...
      <div className="flex justify-between items-center mt-8 gap-4 px-2">
        ...
        {currentStep < STEPS.length ? (
          <Button
            ...
            className="rounded-full px-8 bg-[#059669] hover:bg-[#047857] font-sans text-sm text-white shadow-md hover:scale-105 transition-all duration-300"
          >
            Siguiente
          ...
          <Button
            ...
            disabled={isSubmitting}
            className="rounded-full px-8 bg-[#059669] hover:bg-[#047857] font-sans text-sm text-white shadow-md hover:scale-[1.03] transition-all duration-300"
          >
            {isSubmitting ? (
              <>
